...
- **Specialization Armories & Reliquary:** Choosing a crest toggles Tempest, Bastion, or Chorus outfitters on Earth, while the Leviathan Reliquary event stocks Triad confluence mods and raid relics for Rank V pilots.【F:data/atlantean/atlantean.txt†L640-L708】【F:data/atlantean/atlantean.txt†L2044-L2063】
...
- **Deep Talent Trees & Roles:** Specialization crests and synergy mods exist, yet there are still no multi-tier talent trees, active cooldown mechanics, or class-defining ability rotations beyond passive implants.
